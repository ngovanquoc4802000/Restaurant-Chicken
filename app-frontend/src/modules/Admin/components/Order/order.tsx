              ...
              <tr key={item.id}>
                ...
                <td className="font-bold border border-solid border-gray-500 p-2.5 text-left ">
                  ...
                  {item.process === "Completed" ? (
                    <button className="bg-[#6c757d] text-white border-none px-[14px] mb-0.5 py-[12px] rounded-[4px] cursor-not-allowed">
                      Deactivate
                    </button>
                  ) : (
                    <button className="bg-[#dc3545] text-white border-none px-[14px] mb-0.5 py-[12px] rounded-[4px] cursor-not-allowed">
                      Deactivated
                    </button>
                  )}
                </td>
