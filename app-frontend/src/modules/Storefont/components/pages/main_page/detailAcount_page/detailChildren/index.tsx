            ...
            {rule === "customer" ? (
              <>
                <InputValue
                  ...
                  text="Your name *"
                  type="text"
                  defaultValue={stateLogin.fullname}
                  classNameInput="mt-1 block w-full border-b border-gray-400 focus:outline-none py-1"
                />
                <InputValue
                  classNameLabel="block text-sm font-medium"
                  placeholder="Hãy điền thông tin điện thoại vào đây..."
                  text="Your Telephone *"
                  type="text"
                  defaultValue={stateLogin.phone_number}
                  classNameInput="mt-1 block w-full border-b border-gray-400 focus-outline-none py-1"
                />
                <InputValue
                  classNameLabel="block text-sm font-medium"
                  text="Your Email *"
                  type="email"
                  defaultValue={stateLogin.email}
                  classNameInput="mt-1 block w-full border-b border-gray-400 focus:outline-none py-1 text-gray-400"
                />
                <Button
                  text="Update Account"
                  type="submit"
