  ...
  return (
    <div className="modal-backdrop fixed top-0 left-0 w-[100vw] h-[100vh] bg-black/60 flex justify-center items-center z-[9999]">
     <div className="modal-box bg-white p-6 w-[90%] max-w-[400px] rounded-[8px] text-center">
      <h2 className="text-[18px] mb-2.5 font-bold text-black md:text-[20px] font-medium lg:text-[22px]">
        Login
      </h2>
      <form onSubmit={handleSubmit}>
        ...
        />
        <Button className="btn-register mt-2 hover:bg-red-500 bg-[#e4002b] text-[16px] w-full md:text-[18px] text-white p-3 border-none rounded-3xl font-bold cursor-pointer text-[1.1rem]" type="submit" text="Login" />
      </form>
     </div>
    </div>
  );
