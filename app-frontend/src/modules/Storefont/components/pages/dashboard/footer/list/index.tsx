...
function ListFooter({
  ...
  classNameLi = "mb-[0.5rem] lg:text-[18px] md:text-[16px] cursor-pointer",
  item,
  itemImage,
  itemIcons,
  ...
  onClickItem,
  classNameTitle = "text-[1.4rem] text-[#ff] font-semibold",
  textTitle,
}: ListClassNameTs) {
  ...
  return (
    <div className="footer__column mb-0 md:mb-0">
      <h3
        className={`flex text-[18px] font-bold lg:text-[20px] justify-between items-center ${classNameTitle} text-white`}
      >
        {" "}
        {textTitle}
        <button
