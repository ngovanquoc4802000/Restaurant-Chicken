...
function CreateDishlist() {
  const [value, setValue] = useState<DishListFace>({
    title: "",
    content: "",
    price: "",
  });
  ...
  const handleSubmit = async (e: { preventDefault: () => void }) => {
    ...
    await axios.post<DishListFace>(`http://localhost:7777/dishlist/image`, formData, {
  ...
  return (
    <div className="bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <h2 className="mt-6 text-center text-3xl leading-9 font-extrabold text-gray-900">Create a new DishList</h2>
      </div>
