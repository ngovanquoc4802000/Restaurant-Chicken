...
function ShowAll() {
  ...
  const handleDelete = async (id: number | undefined) => {
    axios.delete<DishListFace>(`http://localhost:7777/dishlist/${id}`);
    getDishAll();
  };
                  ...
                  <tr key={id} className="bg-white transition-all duration-500 hover:bg-gray-50">
                    ...
                    <td className=" px-5 py-3">
                      <div className="w-48 flex items-center gap-3">
                        <img className="w-12 h-12 rounded-full " src={`http://localhost:7777/${item.image}`} alt="Floyd image" />
                        <div className="data">
                          <p className="font-normal text-sm text-gray-900">{item.title}</p>
                          <p className="font-normal text-xs leading-5 text-gray-400">{item.content} </p>
                        </div>
                      </div>
                    </td>
                    <td className="flex p-5 items-center gap-0.5">
                      {/* Edit */}
                      <Link to={`/dishlist/update/${item.id}`}>
